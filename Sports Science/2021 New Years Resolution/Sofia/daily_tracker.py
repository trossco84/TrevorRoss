...
trdf = pd.read_csv('/Users/tross/WILD/RossCo/MyRepo/TrevorRoss/Sports Science/2021 New Years Resolution/Sofia/data.csv',index_col=0)
...
def interaction():
    intentions = {0:"Input Morning",1:"Input Lunch",2:"Input Dinner",3:"Input Exercise",4:"Retrieve Data"}
...
def create_data():
    ...
    trdf.to_csv('/Users/tross/WILD/RossCo/MyRepo/TrevorRoss/Sports Science/2021 New Years Resolution/Sofia/data.csv',index=True)
